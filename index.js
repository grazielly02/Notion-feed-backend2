...
app.get("/config", (req, res) => res.sendFile(path.join(__dirname, "public", "form.html")));
...
app.get("/widget/:clientId/posts", async (req, res) => {
  ...
  try {
    ...
    if (!configRow) return res.status(404).send("Configuração deste cliente não encontrada.");
