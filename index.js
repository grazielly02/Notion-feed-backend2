...
try {
await db.query(  CREATE TABLE IF NOT EXISTS configs (   clientId TEXT PRIMARY KEY,   token TEXT NOT NULL,   databaseId TEXT NOT NULL,   created_at TIMESTAMP DEFAULT now(),   updated_at TIMESTAMP   );  );
...
try {
await db.query(  CREATE TABLE IF NOT EXISTS allowed_clients (   id uuid PRIMARY KEY DEFAULT gen_random_uuid(),   email TEXT UNIQUE NOT NULL,   clientId TEXT UNIQUE NOT NULL,   created_at TIMESTAMP DEFAULT now()   );  );
